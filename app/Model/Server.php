        ...
        return array(
            'MISP' => array(
                ...
                'default_restsearch_limit' => array(
                    'level' => 1,
                    'description' => 'Default number of attributes returned for the given restSearch API. For the Event and Object scopes, a divisor is used to further limit the given value (dividing by 10 and 3 respectively). Can be overridden via the role configurations. Leave empty(0) to set it as unlimited.',
                    'value' => 0,
                    'errorMessage' => '',
                    'null' => true,
                    'type' => 'numeric'
