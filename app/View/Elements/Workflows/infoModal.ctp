        ...
        <div class="tab-content">
            <div class="tab-pane active" id="modal-info-concept">
                ...
                <ul>
                    ...
                    <li><strong><?= __('Module Filtering Conditions:') ?></strong> <?= __('Some action modules accept filtering conditions. This basic filtering allows users to limit module execution to a specific portion of the data.') ?></li>
                    <ul>
